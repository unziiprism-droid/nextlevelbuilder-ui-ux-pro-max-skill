...
/**
 * Floating WhatsApp button, kept small and secondary so it doesn't read
 * as the site's primary contact channel. Inactive (renders nothing)
 * until chatConfig.whatsappNumber is set in src/lib/site-config.ts.
 */
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-40 flex size-11 items-center justify-center rounded-full bg-surface text-[#25D366] shadow-lifted ring-1 ring-border transition-transform duration-300 hover:scale-105"
    >
      <svg viewBox="0 0 24 24" className="size-5.5" fill="currentColor" aria-hidden>
