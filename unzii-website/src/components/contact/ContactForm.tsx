  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <button
        ...
        className="group mt-2 inline-flex items-center justify-center gap-2 rounded-full bg-brand-steel px-6 py-3.5 text-sm font-medium text-text-inverse transition-all duration-300 hover:opacity-90 active:scale-[0.98] disabled:opacity-60"
      >
