      ...
      <div className="mt-8 flex items-center justify-between">
        ...
        {step < steps.length - 1 ? (
          <button
            ...
            onClick={() => setStep((current) => current + 1)}
            className="group inline-flex items-center gap-2 rounded-full bg-brand-steel px-6 py-3 text-sm font-medium text-text-inverse transition-all duration-300 hover:opacity-90 active:scale-[0.98] disabled:opacity-40 disabled:hover:opacity-40"
          >
            Continue
            <ArrowRight
